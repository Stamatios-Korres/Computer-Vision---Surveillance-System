...
model.shoes = fitcsvm(Xtr,Ytr.shoes,'KernelFunction','rbf','KernelScale',35);
...
model.upred = fitcsvm(Xtr,Ytr.upred,'KernelFunction','rbf','KernelScale',30);
...
fprintf('The average precision of attribute recognition is:%.2f \n', mAP*100)
